...
def get_args_parser():
    parser = argparse.ArgumentParser('Placement transformer detector', add_help=False)
    ...
    parser.add_argument('--is_mask', action='store_true', 
                        help='Activate causal attention mask for sequential placement')
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        test_stats, coco_evaluator = evaluate(
            model, criterion, postprocessors, data_loader_val, base_ds, device, args.output_dir, args.data_path
        )
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('BOOTPLACE training and evaluation script', parents=[get_args_parser()])
